...
function mergeData() {
  ...
  return Object.assign({}, data1, data2, {
    ...
    class: clsx__default['default'](data1 === null || data1 === void 0 ? void 0 : data1.class, data2 === null || data2 === void 0 ? void 0 : data2.class)
  });
}
...
function XyzTransitionGroup(props, context) {
  ...
  return vue.h(vue.TransitionGroup, data, childrenFn);
}
